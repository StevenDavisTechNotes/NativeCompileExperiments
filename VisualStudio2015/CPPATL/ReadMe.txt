========================================================================
    ACTIVE TEMPLATE LIBRARY : CPPATL Project Overview
========================================================================

AppWizard has created this CPPATL project for you to use as the starting point for
...
CPPATL.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CPPATL.h)
        GUID definitions                                (CPPATL_i.c)
        A type library                                  (CPPATL.tlb)
        Marshaling code                                 (CPPATL_p.c and dlldata.c)

CPPATL.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CPPATL.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CPPATL.pch and a precompiled types file named StdAfx.obj.
...
CPPATLps.vcxproj
	...
	dlldata.c, CPPATL_i.c and CPPATL_p.c which are required
	to build the proxy/stub DLL.

CPPATLps.vcxproj.filters
